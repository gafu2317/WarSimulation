...
namespace WarSimulation.Kingdom.EditorOnly
{
    public static class KingdomAssetCatalogBuilder
    {
        ...
        static readonly string[] DisplayOrder =
        {
            ...
            "WarriorAcademy_Lv1", "WarriorAcademy_Lv2", "WarriorAcademy_Lv3", "WarriorAcademy_Lv4", "WarriorAcademy_Lv5",
            "ArcaneAcademy_Lv1", "ArcaneAcademy_Lv2", "ArcaneAcademy_Lv3", "ArcaneAcademy_Lv4", "ArcaneAcademy_Lv5",
            "SpiritAcademy_Lv1", "SpiritAcademy_Lv2", "SpiritAcademy_Lv3", "SpiritAcademy_Lv4", "SpiritAcademy_Lv5",
