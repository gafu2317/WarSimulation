...
public sealed class CombatAiObjectiveTests
{
    ...
    public void Planner_StableAllyFrontlineRaisesDamageDealerStoneObjectiveScore()
    {
        ...
        try
        {
            ...
            Assert.That(withScore - withoutScore, Is.EqualTo(56f).Within(0.001f));
        }
        finally
        {
    ...
    [Test]
    public void Planner_CoveredEnemyAssignsUnclaimedStoneAssaultToDamageDealer()
    {
        GameObject ownerGo = new GameObject("StoneAssaulter");
        GameObject allyGo = new GameObject("FrontlineAlly");
        GameObject enemyGo = new GameObject("CoveredEnemy");
        try
        {
            Character owner = ownerGo.AddComponent<Character>();
            owner.Health.Initialize(30);
            owner.EquipWeapon(new Sword());
            owner.SetBattleParticipantId(2);
            Character ally = allyGo.AddComponent<Character>();
            ally.Health.Initialize(30);
            ally.EquipWeapon(new Sword());
            ally.SetBattleParticipantId(1);
            Character enemy = enemyGo.AddComponent<Character>();
            enemy.SetTeam(CombatTeam.Enemy);
            enemy.Health.Initialize(30);
            enemyGo.transform.position = new Vector3(4f, 0f, 0f);
            ...
            CollectionAssert.Contains(
                snapshot.SelectedObjective.Breakdown.ReasonCodes,
    ...
    [Test]
    public void Planner_ExistingStoneAssaulterLeavesDamageDealerOnEnemy()
    {
        GameObject ownerGo = new GameObject("FrontlineOwner");
        GameObject allyGo = new GameObject("ExistingStoneAssaulter");
        GameObject enemyGo = new GameObject("Enemy");
        try
        {
            Character owner = ownerGo.AddComponent<Character>();
    ...
    [Test]
    public void Planner_StoneAssaultCommitmentSurvivesDistantEnemyReappearance()
    {
        GameObject ownerGo = new GameObject("CommittedStoneAssaulter");
        GameObject enemyGo = new GameObject("ReappearedEnemy");
        try
        {
            Character owner = ownerGo.AddComponent<Character>();
            owner.Health.Initialize(30);
            owner.EquipWeapon(new Sword());
            owner.SetBattleParticipantId(1);
            Character enemy = enemyGo.AddComponent<Character>();
            enemy.SetTeam(CombatTeam.Enemy);
            enemy.Health.Initialize(30);
            enemyGo.transform.position = new Vector3(12f, 0f, 0f);
    ...
    [Test]
    public void Planner_StoneAssaultCommitmentEndsWhenOwnerIsThreatened()
    {
        GameObject ownerGo = new GameObject("ThreatenedStoneAssaulter");
        GameObject enemyGo = new GameObject("NearbyEnemy");
        try
        {
            Character owner = ownerGo.AddComponent<Character>();
            owner.Health.Initialize(30, 10);
            owner.EquipWeapon(new Sword());
            owner.SetBattleParticipantId(1);
            Character enemy = enemyGo.AddComponent<Character>();
            enemy.SetTeam(CombatTeam.Enemy);
            ...
            CombatAiContext context = CreatePlannerContext(
                ...
                ownStonePosition: new Vector3(-20f, 0f, 0f),
                hasEnemyStonePosition: true,
                enemyStonePosition: new Vector3(20f, 0f, 0f));
            ...
            Assert.That(snapshot.SelectedObjective.Objective, Is.Not.EqualTo(CombatObjective.DestroyEnemyStone));
